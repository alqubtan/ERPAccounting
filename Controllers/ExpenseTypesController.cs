...
namespace SamaERP.Controllers
{
    public class ExpenseTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Expense_Type")] ExpenseType expenseType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Expense_Type")] ExpenseType expenseType)
        {
